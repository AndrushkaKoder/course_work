...
Пояснительная записка, диаграммы, приложения и материалы к защите: [docs/coursework/](docs/coursework/).
...
| **Автомобили** | Марка, модель, класс, VIN, год, цена, цвет, пробег, тип, статус на складе, превью и галерея файлов |
